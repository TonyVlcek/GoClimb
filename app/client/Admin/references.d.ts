...
/// <reference path="ts/States/BouldersState.ts" />
/// <reference path="ts/States/BoulderCreateState.ts" />
/// <reference path="ts/States/BoulderEditState.ts" />
/// <reference path="ts/States/DashboardState.ts" />
/// <reference path="ts/States/EventsState.ts" />
/// <reference path="ts/States/EventCreateState.ts" />
/// <reference path="ts/States/EventEditState.ts" />
...
/// <reference path="ts/States/RopesState.ts" />
/// <reference path="ts/States/RopeCreateState.ts" />
/// <reference path="ts/States/RopeEditState.ts" />
...
/// <reference path="ts/Controllers/BouldersController.ts" />
